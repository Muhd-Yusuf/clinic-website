// SVG icon components — all use currentColor so they inherit from parent.
// Heroicons-style (24px viewBox, strokeWidth 1.5, stroke="currentColor", fill="none")
// except StarIcon (solid fill) and WhatsAppIcon (brand fill path).
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 2C6.477 2 2 6.477 2 12c0 1.88.52 3.638 1.426 5.142L12 3.5l8.574 13.642A9.953 9.953 0 0 0 22 12c0-5.523-4.477-10-10-10Zm0 0v20"
      />
    </svg>
  );
}

export function AcademicCapIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function MicroscopeIcon({ className, style }: IconProps) {
  // Using a beaker/flask shape as requested
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15M14.25 3.104c.251.023.501.05.75.082M19.8 15a2.25 2.25 0 0 1 .45 1.317C20.25 17.993 18.25 20 12 20s-8.25-2.007-8.25-3.683A2.25 2.25 0 0 1 4.2 15m15.6 0H4.2"
      />
    </svg>
  );
}
...
export function FlowerIcon({ className, style }: IconProps) {
  // Sparkle/flower shape
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function SyringeIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function Bars3Icon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
