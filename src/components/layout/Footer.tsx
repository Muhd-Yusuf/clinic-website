      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#B0A0A0' }}>
              {t.footer.tagline}
            </p>
          ...
          <div>
            <h4 className="text-base font-semibold mb-4" style={{ color: 'var(--color-accent-light)' }}>
              {t.footer.quickLinks}
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: '#B0A0A0' }}>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+972501234567" className="hover:text-[color:var(--color-accent-light)] transition-colors">
                  {t.footer.phone}
                </a>
              </li>
              <li className="flex items-center gap-2">
        ...
        >
          <p>
            © {new Date().getFullYear()} {t.footer.clinicName}. {t.footer.rights}.
          </p>
        </div>
      </div>
    </footer>
